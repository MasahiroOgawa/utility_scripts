...
###
# to ignore "The public cudnn-local-repo-debian12-9.1.0 GPG key does not appear to be installed." error, do not; set -e.
...
echo "[INFO] install driver and cudnn..."
...
DEB_FILE=cudnn-local-repo-debian12-9.1.0_1.0-1_amd64.deb
if [ ! -f ${DEB_FILE} ]; then
